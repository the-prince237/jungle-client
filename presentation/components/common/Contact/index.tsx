...
export const Contacts = () => {
  ...
  const socialPlatforms = [
    ...
    // },
    {
      ...
      link: 'mailto:contact@jungle.immo',
      description: 'Contact Us'
    },
  ];

  return (
    <div id='contacts' className="min-h-screen py-25 bg-linear-to-br from-foreground to-card-foreground relative w-full">
      {/* Animated Background */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))] from-secondary/20 via-transparent to-transparent"></div>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,var(--tw-gradient-stops))] from-primary/20 via-transparent to-transparent"></div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-block mb-4 px-4 py-1.5 bg-linear-to-r from-primary/10 to-primary/50 rounded-full border border-primary/20">
        ...
        <div className={`mt-16 w-full max-w-lg text-center transition-all duration-1000 delay-700 flex items-center gap-2 flex-col sm:flex-row ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <a className='w-full min-w-fit sm:w-1/2' href="tel:+237673080527" target="_blank" rel="noopener noreferrer">
          ...
          <a className='w-full sm:w-1/2' href="https://chat.whatsapp.com/K8uqdFK1fAFIxJlHgKj1p7" target="_blank" rel="noopener noreferrer">
